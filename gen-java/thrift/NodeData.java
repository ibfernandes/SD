...
public class NodeData implements org.apache.thrift.TBase<NodeData, NodeData._Fields>, java.io.Serializable, Cloneable, Comparable<NodeData> {
  ...
  private static final org.apache.thrift.protocol.TField CLUSTER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("clusterId", org.apache.thrift.protocol.TType.I32, (short)4);
  ...
  public NodeData setIp(java.lang.String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public NodeData setClusterId(int clusterId) {
    this.clusterId = clusterId;
    setClusterIdIsSet(true);
    return this;
  }
